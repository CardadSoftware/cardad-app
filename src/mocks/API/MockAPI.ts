...
const testVehicles: IVehicle[] = [
  {
    _id: new mongooseTypes.ObjectId(),
    name: 'Ford F-150',
    model: testCarModels.find(f => f.name == 'F-150'),
    make: testCarMakes.find(f => f.name == 'Ford'),
    year: '2021',
  ...
  },
  {
    _id: new mongooseTypes.ObjectId(),
    name: 'Toyota Corolla',
    model: testCarModels.find(f => f.name == 'Corolla'),
    make: testCarMakes.find(f => f.name == 'Toyota'),
    year: '2019',
  ...
  },
  {
    _id: new mongooseTypes.ObjectId(),
    name: 'Tesla Model 3',
    model: testCarModels.find(f => f.name == 'Model 3'),
    make: testCarMakes.find(f => f.name == 'Tesla'),
    year: '2022',
  ...
  },
  {
    _id: new mongooseTypes.ObjectId(),
    name: 'Honda Civic',
    model: testCarModels.find(f => f.name == 'Civic'),
    make: testCarMakes.find(f => f.name == 'Honda'),
    year: '2018',
  ...
  },
  {
    _id: new mongooseTypes.ObjectId(),
    name: 'Chevy Tahoe',
    model: testCarModels.find(f => f.name == 'Tahoe'),
    make: testCarMakes.find(f => f.name == 'Chevrolet'),
    year: '2020',
